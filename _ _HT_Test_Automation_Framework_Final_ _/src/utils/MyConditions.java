...
public class MyConditions {
	 ...
	 * @author focalpt
	 */
	public static JSCondition<Boolean> AjaxComplete(long timeoutSecs) throws Exception {
		return new JSCondition<Boolean> (){
	 ...
	 */
	public static JSCondition<Boolean> javaScriptThrowsNoExceptions(
	 ...
	 */
	public static JSCondition<Object> jsReturnsValue(
			final String javaScript) {
		return new JSCondition<Object>() {
			@Override
